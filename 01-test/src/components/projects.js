  ...
  const projectArray = [
    {
      ...
      deployed: "https://town-crier-app.herokuapp.com/.",
      source: "https://github.com/EfSoren/Town-Crier",
      image: townCrier,
      description:
        "A group project done using agile development practices. The purpose of this project is to allow users to connect with others based on their location. I developed the back end routing and database structure for this project.",
    },
    {
      title: "Tech Blog",
      ...
      description:
        "A solo project I undertook to further my skills creating a tech blog. Users can post and comment with others about all things tech.",
      image: blogSS,
    },
    {
    ...
    },
    {
      ...
      description:
        "A school assignment to create a site to track daily activities and schedules, that persists data in storage between page visits.",
      image: planner,
    },
  ];
